...
return [
    ...
    'timestamp' => 1573039460,
    'checksum' => '02beaa290e4459c2af75a800e251ea15',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'site.contacts.email' => [
                ...
                'name' => 'site.contacts.email',
                'validation' => 'loose'
            ],
            'site.contacts.youtube' => [
                'type' => 'text',
                'label' => 'YouTube',
                'name' => 'site.contacts.youtube',
                'validation' => 'loose'
            ],
            'site.contacts.instagram' => [
                ...
                'name' => 'site.contacts.instagram',
                'validation' => 'loose'
            ],
            'site.contancts.fieldset' => [
                'type' => 'fieldset',
                'text' => 'Добавьте эл.почту и ссылки на соц.сети',
                'icon' => 'link',
                'collapsed' => true,
                'collapsible' => true,
                'name' => 'site.contancts.fieldset',
                'validation' => 'loose'
            ],
            'site.firstsection' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'site.firstsection',
                'validation' => 'loose'
            ],
            'backups' => [
                'type' => '_root',
        ...
        'nested' => [
            'site' => [
                ...
                'firstsection' => 'site.firstsection',
                'contancts' => [
                    'fieldset' => 'site.contancts.fieldset'
                ],
                'contacts' => [
                    'phone' => 'site.contacts.phone',
                    'email' => 'site.contacts.email',
                    'youtube' => 'site.contacts.youtube',
