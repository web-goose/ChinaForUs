...
<body>
<header style="background: url($bgUrl) center">
 ...
 <section class="contacts">
    ...
    <div class="container wrap-info wow fadeInUp" data-wow-delay=".3s">
        <div class="row d-flex justify-content-center text-center">
            <div class="col-12">E-mail: hello@company.com</div>
            <div class="col-12">Телефон: +123 466 567 78</div>
            <div class="col-12">Соцсети: <a href="">Instagram</a> | <a href="">Youtube</a></div>
        </div>
    </div>
</section>
_HTML;
