    ...
    <div id="timeline">
        ...
        <div class="timeline-item">
            ...
            <div class="timeline-content right wow fadeIn" data-wow-delay=".3s">
                ...
                <p>
                    Проведение обзоров, тестирование, испытание образцов (при необходимости). Предоставлеие результатов
        ...
        <div class="timeline-item">
            ...
            <div class="timeline-content wow fadeIn" data-wow-delay=".3s">
                <h2>Консолидация</h2>
                <p>
                    Консолидация образцов, упаковка, усиление (укреплиние упаковки), отправка образцов на адрес (при
                    необходимости)
                </p>
            </div>
        </div>
        ...
        <div class="timeline-item">
            ...
            <div class="timeline-content right wow fadeIn" data-wow-delay=".3s">
                <h2>Выкуп партии</h2>
                <p>
                    Осуществлеие заказа или выкупа партии, защита сделки. Проведение выборочной инспекции на нашем
